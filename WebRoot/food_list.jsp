...
<body>
	...
	<div id="cl-wrapper">
		...
		<div class="container-fluid" id="pcont">
			...
			<div class="cl-mcont">
				<div class="row">
					<div class="col-md-12">
						<a href="<%=basePath%>food/findFoodDateAll" class="btn btn-primary btn-flat">返回</a>
						<a class="btn btn-warning btn-flat" href="<%=basePath%>evaluate/findEvaluateAll?date=${date}">留言列表</a>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
							...
							<div class="content">
								<div class="table-responsive">
									<table class="table table-bordered" id="datatable">
										...
										<tbody>
											<c:forEach items="${foodList }" var="obj" varStatus="_v">
												<tr class="odd gradeX">
													<td>${_v.count }</td>
													<td>
														<img src="<%=basePath%>file/${obj.imgurl}" width="100px" height="100px">
													</td>
													<td>${obj.name }</td>
													<c:if test="${roler=='0' }">
														<td>
															<button class="btn btn-danger btn-xs btn-flat md-trigger" data-modal="colored-warning" onclick="javascript:$('#delId').val('${obj.foodid}');"><i class="fa fa-times"></i></button>
														</td>
													</c:if>
												</tr>
											</c:forEach>
	...
	<div class="md-modal colored-header warning md-effect-10" id="colored-warning">
		<div class="md-content">
			<form action="<%=basePath%>food/deleteFood" method="post">
	            ...
	            <div class="modal-body">
					<div class="text-center">
						<h4>删除后无法恢复，请谨慎操作！！！</h4>
						<input type="hidden" name="foodId" id="delId">
