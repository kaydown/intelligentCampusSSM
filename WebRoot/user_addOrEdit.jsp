		...
		<div class="container-fluid" id="pcont">
			<div class="page-head">
				<ol class="breadcrumb">
					...
					<li>学生列表</li>
					<li class="active">
						<c:if test="${user.userid==null }">添加学生信息</c:if>
						<c:if test="${user.userid!=null }">编辑学生信息</c:if>
					</li>
				</ol>
			</div>
			<div class="cl-mcont">
				<div class="row">
			      <div class="col-md-12">
			        <div class="block-flat">
			          ...
			          <div class="content">
			             <form class="form-horizontal group-border-dashed" action="<%=basePath%>user/addOrUpdateUser" style="border-radius: 0px;" method="post">
			              ...
			              <div class="form-group">
			                ...
			                <div class="col-sm-6">
			                  <input type="text" class="form-control" name="pwd" value="${user.pwd }" maxlength="10">
			                </div>
			              </div>
			              <div class="form-group">
				               <label class="col-sm-3 control-label">个人简介：</label>
				               <div class="col-sm-6">
				               	<textarea class="form-control" name="content" value="${user.content }">${user.content }</textarea>
				              </div>
				          </div>
