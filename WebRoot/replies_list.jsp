...
<body>
							...
							<div class="content">
								<div class="table-responsive">
									<table class="table table-bordered" id="datatable">
										...
										<tbody>
											<c:forEach items="${repliesList }" var="obj" varStatus="_v">
												<tr class="odd gradeX">
													<td>${_v.count }</td>
													<td>${obj.username }</td>
													<td>${obj.content }</td>
													...
													<td>
														<c:if test="${roler=='0'||obj.userid==uid }">
															<button class="btn btn-danger btn-xs btn-flat md-trigger" data-modal="colored-warning" onclick="javascript:$('#delId').val('${obj.repliesid}');"><i class="fa fa-times"></i></button>
														</c:if>
													</td>
												</tr>
											</c:forEach>
	...
	<div class="md-modal colored-header warning md-effect-10" id="colored-warning">
		<div class="md-content">
			<form action="<%=basePath%>replies/deleteReplies" method="post">
	            ...
	            <div class="modal-body">
					<div class="text-center">
						<h4>删除后无法恢复，请谨慎操作！！！</h4>
						<input type="hidden" name="repliesId" id="delId">
