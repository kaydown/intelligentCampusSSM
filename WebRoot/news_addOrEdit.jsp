		...
		<div class="container-fluid" id="pcont">
			<div class="page-head">
				<ol class="breadcrumb">
					...
					<li class="active">
						<c:if test="${type=='1' }">
							<c:if test="${news.newsid==null }">添加学校信息</c:if>
							<c:if test="${news.newsid!=null }">编辑学校信息</c:if>
						</c:if>
						<c:if test="${type=='2' }">
							<c:if test="${news.newsid==null }">添加公寓信息</c:if>
							<c:if test="${news.newsid!=null }">编辑公寓信息</c:if>
						</c:if>
					</li>
				</ol>
			</div>
