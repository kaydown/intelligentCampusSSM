				...
				<ul class="nav navbar-nav navbar-right user-nav">
					<li class="dropdown profile_menu">
						...
						<ul class="dropdown-menu">
							<li class="divider"></li>
							<li><a href="<%=basePath%>user/beforeAddOrUpdateUser?userId=${obj.userid}">修改个人信息</a></li>
		...
		<div class="container-fluid" id="pcont">
			...
			<div class="cl-mcont">
				<div class="row">
					<div class="col-md-12">
			          <div class="content">
			             <form class="form-horizontal group-border-dashed" action="<%=basePath%>replies/addOrUpdateReplies" style="border-radius: 0px;" method="post">
			              <input type="hidden" name="userid" value="${uid }">
			              <input type="hidden" name="noteid" value="${noteid }">
			              <div class="form-group">
			                <label class="col-sm-3 control-label">发布评论：</label>
			                <div class="col-sm-6">
				...
				<ul class="cbp_tmtimeline">
					<c:forEach items="${repliesList }" var="obj">
						<li>
