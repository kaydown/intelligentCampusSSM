				...
				<div class="row">
			      <div class="col-md-12">
			        <div class="block-flat">
			          ...
			          <div class="content">
			             <form class="form-horizontal group-border-dashed" action="<%=basePath%>evaluate/addOrUpdateEvaluate" style="border-radius: 0px;" method="post">
			              <input type="hidden" name="evaluateid" value="${evaluate.evaluateid }">
			              <input type="hidden" name="userid" value="${uid }">
			              <input type="hidden" name="date" value="${date }">
			              <div class="form-group">
			                <label class="col-sm-3 control-label">内容：</label>
			                <div class="col-sm-6">
			                  <textarea class="form-control" name="content" value="${evaluate.content }">${evaluate.content }</textarea>
			                </div>
			              </div>
