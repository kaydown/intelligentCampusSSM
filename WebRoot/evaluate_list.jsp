...
<body>
		...
		<div class="container-fluid" id="pcont">
			...
			<div class="cl-mcont">
				<c:if test="${roler=='1' }">
					<div class="row">
						<div class="col-md-12">
							<a href="<%=basePath%>evaluate/beforeAddOrUpdateEvaluate?evaluateId=&date=${date}" class="btn btn-primary btn-flat">
								添加菜谱评论
							</a>
						</div>
					</div>
							...
							<div class="content">
								<div class="table-responsive">
									<table class="table table-bordered" id="datatable">
										...
										<tbody>
											<c:forEach items="${evaluateList }" var="obj" varStatus="_v">
												<tr class="odd gradeX">
													<td>${_v.count }</td>
													<td>${obj.username }</td>
													<td>${obj.content }</td>
													...
													<td>
														<c:if test="${roler=='0'||obj.userid==uid }">
															<button class="btn btn-danger btn-xs btn-flat md-trigger" data-modal="colored-warning" onclick="javascript:$('#delId').val('${obj.evaluateid}');"><i class="fa fa-times"></i></button>
														</c:if>
													</td>
												</tr>
											</c:forEach>
	...
	<div class="md-modal colored-header warning md-effect-10" id="colored-warning">
		<div class="md-content">
			<form action="<%=basePath%>evaluate/deleteEvaluate" method="post">
	            ...
	            <div class="modal-body">
					<div class="text-center">
						<h4>删除后无法恢复，请谨慎操作！！！</h4>
						<input type="hidden" name="evaluateId" id="delId">
