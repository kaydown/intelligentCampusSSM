            ...
            <div class="col-sm-8 col-md-5 center-auto pd-sm-50 pd-xs-20 main_content">
                ...
                <form action="<%=basePath%>user/login" method="post">
                    <div class="form-group mg-t20">
                        ...
                        <input type="text" class="login_input" id="Email1" placeholder="请输入用户名" name="uname"/>
                    </div>
                    <div class="form-group mg-t20">
                        <i class="icon-lock icon_font"></i>
                        <input type="password" class="login_input" id="Password1" placeholder="请输入密码" name="pwd"/>
                    </div>
                    <div class="checkbox mg-b25">
                        <label>
                            <input type="radio" value="0" name="role" checked="checked"/>&nbsp;管理员
                            <input type="radio" value="1" name="role" />&nbsp;学生
                        </label>
                    </div>
                    <button style="submit" class="login_btn">登 录</button>
                    <a href="<%=basePath%>pageJump?jumpPath=/regist">注册</a>
               </form>
        </div>
    </div>
</body>
